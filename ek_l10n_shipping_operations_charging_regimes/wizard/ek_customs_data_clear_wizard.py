...
class EkCustomsDataClearWizard(models.TransientModel):
  _name = 'ek.customs.data.clear.wizard'
  _description = 'Asistente para confirmar eliminación de datos de aduanas'
        ...
        wizard.warning_message = f"""
          <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; border-radius: 5px; margin: 10px 0;">
              ...
              <p style="color: #856404; margin: 0;">
                  Está a punto de eliminar <strong>{wizard.total_records}</strong> registro(s) de datos de aduanas.
              </p>
  ...
  def action_confirm_clear(self):
    ...
    if self.operation_request_ids:
      ...
      self.operation_request_ids.action_clear_customs_data_confirmed()
