...
class ir_model_access(models.Model):
    ...
    def check(self, model, mode='read', raise_exception=True):
        ...
        # Permitir escritura en res.users cuando viene del contexto especial de galería PDF
        if model == 'res.users' and mode == 'write' and self.env.context.get('nsk_pdf_gallery_write'):
            return True
