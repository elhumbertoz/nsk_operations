                ...
                self.env["mail.activity"].sudo().create(
                    {
                        ...
                        "res_model_id": self.env.ref(
                            "ek_l10n_ec_purchase_request.model_purchase_request"
                        ).id,
                    }
                )
                ...
                default["purchase_request_allocation_ids"].append(
                    (
                        ...
                        0,
                        {
                            ...
                            'purchase_line_id': alloc.purchase_request_line_id.purchase_lines and alloc.purchase_request_line_id.purchase_lines[0].id
                        },
                    )
                )
